...
>
    ...
    <defs>
        <linearGradient id="sky" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="hsl(var(--paper-50))"/>
            <stop offset="70%" stop-color="hsl(var(--paper-100))"/>
            <stop offset="100%" stop-color="hsl(var(--paper-200))"/>
        </linearGradient>
        <linearGradient id="rice" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="hsl(var(--ochre-500))"/>
            <stop offset="100%" stop-color="hsl(var(--ochre-700))"/>
        </linearGradient>
    </defs>
    ...
    <g transform="translate(560 220)">
        <g stroke="hsl(var(--flag-500))" stroke-width="4" opacity="0.85">
        ...
        <circle r="90" fill="hsl(var(--flag-500))"/>
        <circle r="90" fill="none" stroke="hsl(var(--ink-900))" stroke-width="4"/>
    </g>
    ...
    <path d="M0 330 L120 290 L240 320 L360 275 L480 305 L600 265 L720 300 L800 285 L800 360 L0 360 Z"
          fill="hsl(var(--flag-700))" opacity="0.55"/>
    <path d="M0 360 L140 330 L280 355 L420 320 L560 345 L700 325 L800 340 L800 400 L0 400 Z"
          fill="hsl(var(--flag-800))" opacity="0.75"/>

    {{-- Garis pesisir + perahu nelayan kecil (motif sekunder) --}}
    <rect x="0" y="380" width="800" height="30" fill="hsl(var(--earth-500))" opacity="0.2"/>
    <g transform="translate(110 388)">
        <path d="M-18 6 L18 6 L12 14 L-12 14 Z" fill="hsl(var(--ink-900))"/>
        <path d="M0 -12 L0 6 M0 -12 L10 4" stroke="hsl(var(--ink-900))" stroke-width="2.5" fill="none" stroke-linecap="round"/>
    </g>

    {{-- Sawah bergelombang (bands horizontal khas realisme sosialis) --}}
    <g>
        <rect x="0" y="410" width="800" height="26" fill="hsl(var(--ochre-500))"/>
        <rect x="0" y="436" width="800" height="22" fill="hsl(var(--ochre-600))"/>
        <rect x="0" y="458" width="800" height="22" fill="hsl(var(--ochre-700))"/>
        <rect x="0" y="480" width="800" height="26" fill="hsl(var(--earth-500))"/>
        <rect x="0" y="506" width="800" height="30" fill="hsl(var(--earth-600))"/>
        <rect x="0" y="536" width="800" height="64" fill="hsl(var(--ink-900))"/>
    </g>

    {{-- Tekstur padi: garis-garis tipis vertikal di band emas (mengacu realism tradisi) --}}
    <g stroke="hsl(var(--ink-900))" stroke-width="1" opacity="0.4">
        @for ($i = 0; $i < 80; $i++)
            @php $x = $i * 10 + 5; @endphp
    ...
    --}}
    <g transform="translate(480 420) scale(1.35)" fill="hsl(var(--ink-900))">
    ...
    <g transform="translate(220 460) scale(0.9)" fill="hsl(var(--ink-800))">
        <path d="M-24 -70 L24 -70 L12 -80 L-12 -80 Z"/>
        <circle cx="0" cy="-60" r="8"/>
        <path d="M-16 -46 L16 -46 L20 -8 L-20 -8 Z"/>
        {{-- Bakul di atas kepala --}}
        <ellipse cx="0" cy="-80" rx="20" ry="5" fill="hsl(var(--ochre-600))"/>
        <path d="M-18 -84 L18 -84 L14 -78 L-14 -78 Z" fill="hsl(var(--ochre-700))"/>
        {{-- Kaki --}}
    ...
    <g transform="translate(660 450)">
        <rect x="0" y="-60" width="3" height="60" fill="hsl(var(--ink-900))"/>
        <path d="M3 -60 L40 -54 L32 -48 L40 -42 L3 -36 Z" fill="hsl(var(--flag-500))" stroke="hsl(var(--ink-900))" stroke-width="2"/>
    </g>
</svg>
